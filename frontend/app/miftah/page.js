      ...
      <main className="page">
        ...
        <motion.div className="shortcut-grid" variants={container} initial="hidden" animate="show">
          <motion.div variants={item}>
            <Link href="/miftah/hifz" className="shortcut-card">
              <div className="card">
                <h3>Hifz</h3>
          ...
          <motion.div variants={item}>
            <Link href="/miftah/circles" className="shortcut-card">
              <div className="card">
                <h3>Circles</h3>
                <p className="muted" style={{ marginBottom: 0 }}>
          ...
          <motion.div variants={item}>
            <Link href="/miftah/miftah-method" className="shortcut-card">
              <div className="card">
        ...
        <motion.div variants={container} initial="hidden" animate="show">
          {filteredSurahs.map((s) => (
            <motion.div key={s.id} variants={item} whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }}>
              <Link href={`/miftah/recite/${s.id}`} style={{ textDecoration: "none", color: "inherit" }}>
